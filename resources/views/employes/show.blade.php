...
@section('title', 'Human Ressources Management App | '.$employe->fullname)
        ...
        <div class="col-md-8">
            <div class="card my-5">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-3">
                        <label for="fullname" class="form-label fw-bold">Poste</label>
                        <div class="border border-secondary rounded p-2">
                            {{$employe->poste}}
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        <label for="fullname" class="form-label fw-bold">E_mail</label>
                        <div class="border border-secondary rounded p-2">
                            {{$employe->e_mail}}
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        <label for="fullname" class="form-label fw-bold">Salaire</label>
                        <div class="border border-secondary rounded p-2">
                            {{$employe->Salaire}}
                        </div>
                    </div>
